...
//menu
define("_CSS_MODULE_HOME","Css Editor Home");
define("_CSS_MODULE_BLOCKCOLOR","CSS Editor Block Color Selector");
define("_CSS_MODULE_TABLECOLOR","CSS Editor Table Color Selector");
...
define("_CSS_MODULE_HEADERFOOTER" , "Css Editor header and footer" ) ;
define("_CSS_MODULE_TAGS" , "Css Editor tags") ;
define("_CSS_MODULE_BASIC" , "Css Editor  Basic Options") ;
