...
$module =& $module_handler->getByDirname('tcm');
...
if ( $op == "savefile" ) {
	...
	$profilehandle = fopen("profiles/" . $tcm['cssxoopsthemesave'], "w+");
	fwrite($profilehandle,$cssprofilecontent ,strlen($cssprofilecontent)); 
	...
	if ($handle = opendir("themes/" . $tcm['cssxoopstheme'])) {
    	while (false !== ($file = readdir($handle))) {
    		if ($file != "." && $file != "..") {
				...
				if (!$tcm['ftpuse']){
					$themehandle = fopen(XOOPS_ROOT_PATH ."/themes/" . $tcm['cssxoopstheme']  . "/" . $file, "w+");
					fwrite($themehandle,$defaultcssthemecontent,strlen($defaultcssthemecontent)); 
					fclose($themehandle);    		
				}else{
					$themehandle = fopen(XOOPS_VAR_PATH ."/data/css-" . $file, "w+");
					fwrite($themehandle,$defaultcssthemecontent,strlen($defaultcssthemecontent)); 
					fclose($themehandle);    		
